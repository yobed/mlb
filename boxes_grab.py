...
class BoxScoreProcess:
    ...
    def get_dataframe(self):
        ...
        df["hometeam_line"] = df["hometeam_line"].apply(lambda x: np.array(x))
        df["visteam_line"] = df["visteam_line"].apply(lambda x: np.array(x))
...
def main():
    ...
    if args.save:
        ...
        df.to_parquet("linescores.parquet")
        df.to_pickle("linescores.pkl")     
